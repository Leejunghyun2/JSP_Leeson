...
<table border="1" width="80%" align="center">
	...
	<tr>
		<td>부모연락처 :</td>
		<td><input type="text" name="parentPhone" value="<%=dto.getParentPhone()%>"></td>
	</tr>
	<tr>
		<td rowspan="2">주소</td>
		<td>
		<input type="text" id="sample6_postcode" placeholder="우편번호" name="addr1" value="<%=dto.getAddr1() %>" readonly>
		<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
		</td>
	</tr>
	<tr>
	 	<td>
	 	<input type="text" id="sample6_address" placeholder="주소" name="addr2" value="<%=dto.getAddr2() %>" readonly>
	 	<input type="text" id="sample6_detailAddress" placeholder="상세주소" value="<%=dto.getAddr3() %>" name="addr3"><br>
	 	<input type="text" id="sample6_extraAddress" placeholder="참고항목" name="addr4" value="<%=dto.getAddr4() %>" readonly>
	 	</td>
	</tr>
	<tr>
