...
public class SihumController extends HttpServlet {
	...
	protected void doProc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(imsiUriFileName.equals("list.do")) {
			...
			sihumNo_ = util.getNullBlankCheck(sihumNo_);
			...
			SihumDAO dao = new SihumDAO();
			SihumDTO returnDto = dao.getSelectOne(arguDto);
			...
			System.out.println(sihumName);
			System.out.println(sihumDate);
			SihumDTO arguDto = new SihumDTO(); 
			...
			System.out.println(sihumNo + sihumName + sihumDate);
